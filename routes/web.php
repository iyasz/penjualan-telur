...
Route::get('/admin/{id}/detail', [adminController::class, 'detail']);
...
Route::get('/jenis-telur/{id}/detail', [jenisTelurController::class, 'detail']);
...
Route::get('/telur/{id}/detail', [telurController::class, 'detail']);
